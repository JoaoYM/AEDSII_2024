...
public class InsertionSort {
    ...
    private String nomeArquivo = "756491_insertion.txt";
    ...
    public static InsertionSort programa = new InsertionSort();

    public static void main(String[] args) {
        programa.nInicioExecucao = System.currentTimeMillis();
        Scanner scan = new Scanner(System.in);
        List<InsertionSort> arrayAcomodacoes = new ArrayList<>();
        Map<String, InsertionSort> acomodacoes = new HashMap<>();
        ...
        for (InsertionSort acomodacao : arrayAcomodacoes) {
    ...
    public InsertionSort(int roomId, int hostId, String roomType, String country, String city, String neighbourhood,
            int reviews,
    ...
    public static Map<String, InsertionSort> readFile() {
        Scanner scan = new Scanner(System.in);
        ...
        try {
            ...
            while ((linha = leitor.readLine()) != null) {
                if (!linha.isEmpty()) {
                    ...
                    InsertionSort registro = new InsertionSort(Integer.parseInt(parametros[0].trim()),
    ...
    public static void printLine(InsertionSort registro) {
    ...
    @Override
    public InsertionSort clone() {
        try {
            InsertionSort clone = (InsertionSort) super.clone();
    ...
    public static List<InsertionSort> selectionSort(List<InsertionSort> acomodacaos) {
        for (int i = 0; i <= acomodacaos.size() - 1; i++) {
            ...
            if (acomodacaos.get(i).getRoomId() != acomodacaos.get(min_index).getRoomId()) {
                ...
                InsertionSort temp = acomodacaos.get(i);
    ...
    public static List<InsertionSort> bubbleSort(List<InsertionSort> acomodacaos) {
        for (int i = 0; i < acomodacaos.size() - 1; i++) {
            for (int j = 0; j < acomodacaos.size() - i - 1; j++) {
                if (acomodacaos.get(j).getOverallSatisfaction() > acomodacaos.get(j + 1).getOverallSatisfaction() ||
                    ...
                    InsertionSort temp = acomodacaos.get(j);
    ...
    public static List<InsertionSort> insertionSort(List<InsertionSort> acomodacoes) {
        for (int i = 1; i < acomodacoes.size(); i++) {
            InsertionSort chave = acomodacoes.get(i);
            int j = i - 1;
    ...
    public static List<InsertionSort> mergeSort(List<InsertionSort> array, int inicio, int fim) {
        programa.nComparacoes++;
        if (inicio < fim) {
    ...
    private static void intercalar(List<InsertionSort> acomodacoes, int inicio, int meio, int fim) {
        List<InsertionSort> arrayTemp = new ArrayList<>(acomodacoes);
    ...
    public static List<InsertionSort> quickSort(List<InsertionSort> acomodacoes, int esquerda, int direita) {
        programa.nComparacoes++;
        if (esquerda < direita) {
    ...
    private static int separar(List<InsertionSort> acomodacoes, int esquerda, int direita) {
        InsertionSort pivo = acomodacoes.get(esquerda);
        int i = esquerda + 1;
        int j = direita;
    ...
    private static int compararAcomodacoes(InsertionSort acomodacao1, InsertionSort acomodacao2) {
        programa.nComparacoes++;
    ...
    public static List<InsertionSort> heapSort(List<InsertionSort> acomodacoes) {
    ...
    public static void maxHeap(List<InsertionSort> acomodacoes, int n, int i) {
        int maior = i;
        int esquerda = 2 * i + 1;
        int direita = 2 * i + 2;
    ...
    public static int compararAcomodacoesHeap(InsertionSort acomodacao1, InsertionSort acomodacao2) {
        programa.nComparacoes++;
