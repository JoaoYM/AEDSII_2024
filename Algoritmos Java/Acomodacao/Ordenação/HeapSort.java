...
public class HeapSort {
    ...
    public static HeapSort programa = new HeapSort();

    public static void main(String[] args) {
        programa.nInicioExecucao = System.currentTimeMillis();
        Scanner scan = new Scanner(System.in);
        List<HeapSort> arrayAcomodacoes = new ArrayList<>();
        Map<String, HeapSort> acomodacoes = new HashMap<>();
        ...
        for (HeapSort acomodacao : arrayAcomodacoes) {
    ...
    public HeapSort(int roomId, int hostId, String roomType, String country, String city, String neighbourhood,
            int reviews,
    ...
    public static Map<String, HeapSort> readFile() {
        Scanner scan = new Scanner(System.in);
        ...
        try {
            ...
            while ((linha = leitor.readLine()) != null) {
                if (!linha.isEmpty()) {
                    ...
                    HeapSort registro = new HeapSort(Integer.parseInt(parametros[0].trim()),
    ...
    public static void printLine(HeapSort registro) {
    ...
    public static List<HeapSort> selectionSort(List<HeapSort> acomodacaos) {
        for (int i = 0; i <= acomodacaos.size() - 1; i++) {
            ...
            if (acomodacaos.get(i).getRoomId() != acomodacaos.get(min_index).getRoomId()) {
                ...
                HeapSort temp = acomodacaos.get(i);
    ...
    public static List<HeapSort> bubbleSort(List<HeapSort> acomodacaos) {
        for (int i = 0; i < acomodacaos.size() - 1; i++) {
            for (int j = 0; j < acomodacaos.size() - i - 1; j++) {
                if (acomodacaos.get(j).getOverallSatisfaction() > acomodacaos.get(j + 1).getOverallSatisfaction() ||
                    ...
                    HeapSort temp = acomodacaos.get(j);
    ...
    public static List<HeapSort> insertionSort(List<HeapSort> acomodacoes) {
        for (int i = 1; i < acomodacoes.size(); i++) {
            HeapSort chave = acomodacoes.get(i);
            int j = i - 1;
    ...
    public static List<HeapSort> mergeSort(List<HeapSort> array, int inicio, int fim) {
        programa.nComparacoes++;
        if (inicio < fim) {
    ...
    private static void intercalar(List<HeapSort> acomodacoes, int inicio, int meio, int fim) {
        List<HeapSort> arrayTemp = new ArrayList<>(acomodacoes);
    ...
    public static List<HeapSort> quickSort(List<HeapSort> acomodacoes, int esquerda, int direita) {
        programa.nComparacoes++;
        if (esquerda < direita) {
    ...
    private static int separar(List<HeapSort> acomodacoes, int esquerda, int direita) {
        HeapSort pivo = acomodacoes.get(esquerda);
        int i = esquerda + 1;
        int j = direita;
    ...
    private static int compararAcomodacoes(HeapSort acomodacao1, HeapSort acomodacao2) {
        programa.nComparacoes++;
    ...
    public static List<HeapSort> heapSort(List<HeapSort> acomodacoes) {
    ...
    public static void maxHeap(List<HeapSort> acomodacoes, int n, int i) {
        int maior = i;
        int esquerda = 2 * i + 1;
        int direita = 2 * i + 2;
    ...
    public static int compararAcomodacoesHeap(HeapSort acomodacao1, HeapSort acomodacao2) {
        programa.nComparacoes++;
