...
public class QuickSort {
    ...
    private String nomeArquivo = "756491_quick.txt";
    ...
    public static QuickSort programa = new QuickSort();

    public static void main(String[] args) {
        programa.nInicioExecucao = System.currentTimeMillis();
        Scanner scan = new Scanner(System.in);
        List<QuickSort> arrayAcomodacoes = new ArrayList<>();
        Map<String, QuickSort> acomodacoes = new HashMap<>();
        ...
        for (QuickSort acomodacao : arrayAcomodacoes) {
    ...
    public QuickSort(int roomId, int hostId, String roomType, String country, String city, String neighbourhood,
            int reviews,
    ...
    public static Map<String, QuickSort> readFile() {
        Scanner scan = new Scanner(System.in);
        ...
        try {
            ...
            while ((linha = leitor.readLine()) != null) {
                if (!linha.isEmpty()) {
                    ...
                    QuickSort registro = new QuickSort(Integer.parseInt(parametros[0].trim()),
    ...
    public static void printLine(QuickSort registro) {
    ...
    @Override
    public QuickSort clone() {
        try {
            QuickSort clone = (QuickSort) super.clone();
    ...
    public static List<QuickSort> selectionSort(List<QuickSort> acomodacaos) {
        for (int i = 0; i <= acomodacaos.size() - 1; i++) {
            ...
            if (acomodacaos.get(i).getRoomId() != acomodacaos.get(min_index).getRoomId()) {
                ...
                QuickSort temp = acomodacaos.get(i);
    ...
    public static List<QuickSort> bubbleSort(List<QuickSort> acomodacaos) {
        for (int i = 0; i < acomodacaos.size() - 1; i++) {
            for (int j = 0; j < acomodacaos.size() - i - 1; j++) {
                if (acomodacaos.get(j).getOverallSatisfaction() > acomodacaos.get(j + 1).getOverallSatisfaction() ||
                    ...
                    QuickSort temp = acomodacaos.get(j);
    ...
    public static List<QuickSort> insertionSort(List<QuickSort> acomodacoes) {
        for (int i = 1; i < acomodacoes.size(); i++) {
            QuickSort chave = acomodacoes.get(i);
            int j = i - 1;
    ...
    public static List<QuickSort> mergeSort(List<QuickSort> array, int inicio, int fim) {
        programa.nComparacoes++;
        if (inicio < fim) {
    ...
    private static void intercalar(List<QuickSort> acomodacoes, int inicio, int meio, int fim) {
        List<QuickSort> arrayTemp = new ArrayList<>(acomodacoes);
    ...
    public static List<QuickSort> quickSort(List<QuickSort> acomodacoes, int esquerda, int direita) {
        programa.nComparacoes++;
        if (esquerda < direita) {
    ...
    private static int separar(List<QuickSort> acomodacoes, int esquerda, int direita) {
        QuickSort pivo = acomodacoes.get(esquerda);
        int i = esquerda + 1;
        int j = direita;
    ...
    private static int compararAcomodacoes(QuickSort acomodacao1, QuickSort acomodacao2) {
        programa.nComparacoes++;
    ...
    public static List<QuickSort> heapSort(List<QuickSort> acomodacoes) {
    ...
    public static void maxHeap(List<QuickSort> acomodacoes, int n, int i) {
        int maior = i;
        int esquerda = 2 * i + 1;
        int direita = 2 * i + 2;
    ...
    public static int compararAcomodacoesHeap(QuickSort acomodacao1, QuickSort acomodacao2) {
        programa.nComparacoes++;
