...
public class MergeSort {
    ...
    private String nomeArquivo = "756491_merge.txt";
    ...
    public static MergeSort programa = new MergeSort();

    public static void main(String[] args) {
        programa.nInicioExecucao = System.currentTimeMillis();
        Scanner scan = new Scanner(System.in);
        List<MergeSort> arrayAcomodacoes = new ArrayList<>();
        Map<String, MergeSort> acomodacoes = new HashMap<>();
        ...
        for (MergeSort acomodacao : arrayAcomodacoes) {
    ...
    public MergeSort(int roomId, int hostId, String roomType, String country, String city, String neighbourhood,
            int reviews,
    ...
    public static Map<String, MergeSort> readFile() {
        Scanner scan = new Scanner(System.in);
        ...
        try {
            ...
            while ((linha = leitor.readLine()) != null) {
                if (!linha.isEmpty()) {
                    ...
                    MergeSort registro = new MergeSort(Integer.parseInt(parametros[0].trim()),
    ...
    public static void printLine(MergeSort registro) {
    ...
    public MergeSort clone() {
        try {
            MergeSort clone = (MergeSort) super.clone();
    ...
    public static List<MergeSort> selectionSort(List<MergeSort> acomodacaos) {
        for (int i = 0; i <= acomodacaos.size() - 1; i++) {
            ...
            if (acomodacaos.get(i).getRoomId() != acomodacaos.get(min_index).getRoomId()) {
                ...
                MergeSort temp = acomodacaos.get(i);
    ...
    public static List<MergeSort> bubbleSort(List<MergeSort> acomodacaos) {
        for (int i = 0; i < acomodacaos.size() - 1; i++) {
            for (int j = 0; j < acomodacaos.size() - i - 1; j++) {
                if (acomodacaos.get(j).getOverallSatisfaction() > acomodacaos.get(j + 1).getOverallSatisfaction() ||
                    ...
                    MergeSort temp = acomodacaos.get(j);
    ...
    public static List<MergeSort> insertionSort(List<MergeSort> acomodacoes) {
        for (int i = 1; i < acomodacoes.size(); i++) {
            MergeSort chave = acomodacoes.get(i);
            int j = i - 1;
    ...
    public static List<MergeSort> mergeSort(List<MergeSort> array, int inicio, int fim) {
        programa.nComparacoes++;
        if (inicio < fim) {
    ...
    private static void intercalar(List<MergeSort> acomodacoes, int inicio, int meio, int fim) {
        List<MergeSort> arrayTemp = new ArrayList<>(acomodacoes);
    ...
    public static List<MergeSort> quickSort(List<MergeSort> acomodacoes, int esquerda, int direita) {
        programa.nComparacoes++;
        if (esquerda < direita) {
    ...
    private static int separar(List<MergeSort> acomodacoes, int esquerda, int direita) {
        MergeSort pivo = acomodacoes.get(esquerda);
        int i = esquerda + 1;
        int j = direita;
    ...
    private static int compararAcomodacoes(MergeSort acomodacao1, MergeSort acomodacao2) {
        programa.nComparacoes++;
    ...
    public static List<MergeSort> heapSort(List<MergeSort> acomodacoes) {
    ...
    public static void maxHeap(List<MergeSort> acomodacoes, int n, int i) {
        int maior = i;
        int esquerda = 2 * i + 1;
        int direita = 2 * i + 2;
    ...
    public static int compararAcomodacoesHeap(MergeSort acomodacao1, MergeSort acomodacao2) {
        programa.nComparacoes++;
