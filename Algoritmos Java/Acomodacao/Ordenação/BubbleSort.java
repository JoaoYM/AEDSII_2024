...
public class BubbleSort {
    ...
    private String nomeArquivo = "756491_bubble.txt";
    ...
    public static BubbleSort programa = new BubbleSort();

    public static void main(String[] args) {
        programa.nInicioExecucao = System.currentTimeMillis();
        Scanner scan = new Scanner(System.in);
        List<BubbleSort> arrayAcomodacoes = new ArrayList<>();
        Map<String, BubbleSort> acomodacoes = new HashMap<>();
        ...
        for (BubbleSort acomodacao : arrayAcomodacoes) {
    ...
    public static Map<String, BubbleSort> readFile() {
        Scanner scan = new Scanner(System.in);
        ...
        try {
            ...
            while ((linha = leitor.readLine()) != null) {
                if (!linha.isEmpty()) {
                    ...
                    BubbleSort registro = new BubbleSort(Integer.parseInt(parametros[0].trim()),
    ...
    public static void printLine(BubbleSort registro) {
    ...
    @Override
    public BubbleSort clone() {
        try {
            BubbleSort clone = (BubbleSort) super.clone();
    ...
    public static List<BubbleSort> selectionSort(List<BubbleSort> acomodacaos) {
        for (int i = 0; i <= acomodacaos.size() - 1; i++) {
            ...
            if (acomodacaos.get(i).getRoomId() != acomodacaos.get(min_index).getRoomId()) {
                ...
                BubbleSort temp = acomodacaos.get(i);
    ...
    public static List<BubbleSort> bubbleSort(List<BubbleSort> acomodacaos) {
        for (int i = 0; i < acomodacaos.size() - 1; i++) {
            for (int j = 0; j < acomodacaos.size() - i - 1; j++) {
                if (acomodacaos.get(j).getOverallSatisfaction() > acomodacaos.get(j + 1).getOverallSatisfaction() ||
                    ...
                    BubbleSort temp = acomodacaos.get(j);
    ...
    public static List<BubbleSort> insertionSort(List<BubbleSort> acomodacoes) {
        for (int i = 1; i < acomodacoes.size(); i++) {
            BubbleSort chave = acomodacoes.get(i);
            int j = i - 1;
    ...
    public static List<BubbleSort> mergeSort(List<BubbleSort> array, int inicio, int fim) {
        programa.nComparacoes++;
        if (inicio < fim) {
    ...
    private static void intercalar(List<BubbleSort> acomodacoes, int inicio, int meio, int fim) {
        List<BubbleSort> arrayTemp = new ArrayList<>(acomodacoes);
    ...
    public static List<BubbleSort> quickSort(List<BubbleSort> acomodacoes, int esquerda, int direita) {
        programa.nComparacoes++;
        if (esquerda < direita) {
    ...
    private static int separar(List<BubbleSort> acomodacoes, int esquerda, int direita) {
        BubbleSort pivo = acomodacoes.get(esquerda);
        int i = esquerda + 1;
        int j = direita;
    ...
    private static int compararAcomodacoes(BubbleSort acomodacao1, BubbleSort acomodacao2) {
        programa.nComparacoes++;
    ...
    public static List<BubbleSort> heapSort(List<BubbleSort> acomodacoes) {
    ...
    public static void maxHeap(List<BubbleSort> acomodacoes, int n, int i) {
        int maior = i;
        int esquerda = 2 * i + 1;
        int direita = 2 * i + 2;
    ...
    public static int compararAcomodacoesHeap(BubbleSort acomodacao1, BubbleSort acomodacao2) {
        programa.nComparacoes++;
